...
//               <Card
//                 key={index}
//                 className="group cursor-pointer border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-2"
//               >
//                 <CardContent className="p-6">
//                   <div className="mb-4">
//                     <IconComponent
//                       className={`w-8 h-8 ${category.colorClass} transition-colors duration-300`}
//                     />
//                   </div>
//                   <div className="mb-2">
