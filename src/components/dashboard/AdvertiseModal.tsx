...
import { Megaphone, Zap, ArrowUp, AlertTriangle, Crown, Loader2, ShoppingCart } from "lucide-react";
import { activatePromotionAction, bumpUpPropertyAction, getCooldownStatusAction, getUserEntitlementsAction } from "@/modules/promotions/actions/promotions.actions";
    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Boost visibility for {listing.title} using your credits.
          </DialogDescription>
        </DialogHeader>
